...
def main():
    ...
    specs5k_classification_list = pl.read_parquet("/home/jovyan/share/data/analyses/benjamin/Single_cell_supervised/BF_MOA/DeepProfiler/datasets/BF_moa_specs5k_compound_list.parquet")
    print("Importing data")
    
    specs3k_sc_locations = pl.read_parquet("datasets/sc_profiles_classification_specs3k_CellProfiler_standardized.parquet")
    ...
    specs3k_sc_features_total.write_parquet("/home/jovyan/share/data/analyses/benjamin/Single_cell_supervised/BF_MOA/CellProfiler/datasets/specs3k_sc_featfix_CP.parquet")
    #gc.collect()
    #specs2k_sc_locations = pl.read_parquet("datasets/sc_profiles_classification_specs2k_CellProfiler_standardized.parquet")
    ...
    #specs2k_sc_features_total.write_parquet("/home/jovyan/share/data/analyses/benjamin/Single_cell_supervised/BF_MOA/CellProfiler/datasets/specs2k_sc_featfix_CP.parquet")
